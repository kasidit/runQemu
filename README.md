...
<li> <a href="#part8">8. การทำ live migration ของ vm</a> <br>
 ...
 <li> <a href="https://github.com/kasidit/openstack-victoria-basic-installer">เทคโนโลยีที่เกี่ยวข้อง 2: การติดตั้งระบบ OpenStack (Victoria)</a>
</ul>
<p><p>
...
<pre>
On host1: 
$ sudo ip address add 10.0.0.10/24 dev enp68s0f0
$ sudo ip link set ens68s0f0 up
</pre>
...
<pre>
On host1:
$ sudo ip address del 10.0.0.10/24 dev enp68s0f0
$
$ sudo ovs-vsctl add-port br-int xif1 -- set interface xif1 type=internal
$ sudo ip address add 10.0.0.10/24 dev xif1
$ sudo ifconfig xif1 up
</pre>
...
$ qemu-img create -f qcow2 -b vm1.img vm1.ovl
$ qemu-img create -f qcow2 -b vm1.img vm2.ovl
$ cd ../scripts
$ cp vm1.sh vm2.sh
</pre>
...
<pre>
On host1: 
$ cd /srv/kasidit/bookhosts
$ scp etc/\* 10.100.20.152:/srv/kasidit/bookhosts/etc
$ scp images/vm1.img 10.100.20.152:/srv/kasidit/bookhosts/images/vm1.img
$ scp scripts/vm1.sh 10.100.20.152:/srv/kasidit/bookhosts/scripts/vm3.sh
$
</pre> 
